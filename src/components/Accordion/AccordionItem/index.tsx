	...
	return <>
		<AccordionContext.Consumer >
		{
			({visibleId, setVisibleId}) => <>		
				<div className={`shadow-md py-2 text-lg font-semibold px-3 flex justify-between rounded-md cursor-pointer`}
					onClick={
						() => {
							console.log(id)
							setVisibleId(id)
					...
					<i className="ml-5"><FontAwesomeIcon icon={visibleId !== id ? faAngleDown: faAngleUp}/></i>
				</div>
